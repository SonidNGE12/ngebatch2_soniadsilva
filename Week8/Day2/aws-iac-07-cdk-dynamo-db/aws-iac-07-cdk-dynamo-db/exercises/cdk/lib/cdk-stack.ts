...
export class CdkStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: GigsSettings) {
    ...
    // gig data GET lambda
    const getGigDataLambda = new nodejs.NodejsFunction(this, 'get-gig-data-lambda',
      {
    ...
    const getGigDataByIdLambda = new nodejs.NodejsFunction(this, 'get-gig-data-by-id-lambda',
      {
    ...
    const bootstrapGigDataLambda = new nodejs.NodejsFunction(this, 'bootstrap-gig-data-lambda',
      {
    ...
    const postGigDataLambda = new nodejs.NodejsFunction(this, 'post-gig-data-lambda',
      {
