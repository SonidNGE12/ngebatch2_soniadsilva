...
export class PinkGigS3Stack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: GigsSettings) {
    ...
    //Creating and Deploying Flyers Bucket
    ...
    //Creating and Deploying Client Bucket
    ...
    // example resource
    // const queue = new sqs.Queue(this, 'PinkGigS3Queue', {
